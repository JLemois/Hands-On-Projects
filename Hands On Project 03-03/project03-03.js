/*    JavaScript 7th Edition
      ...
      "...generate the HTML code for a web table displaying the top 10 movies from the IMDB website."

      **Lists were created as part of the file download.

      use of arrays and loops to generate table display
...
//Variable for htmlCode to hold blank string to start
let htmlCode = "";

//for loop that is based off of text supplied by book
//Broke down the htmlCode += because i got lost on where my quotes were supposed to be
//This came out a bit more organized and allows for same visual aid as typing it in HTML in general
