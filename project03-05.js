/*    JavaScript 7th Edition
    ...
    Debugging challenge
    * remembered to add comments to the changes this time around. easy to lose track of them
*/

// Array of phone models sold by the company
let phones = ["Photon 6E", "Photon 6X", "Photon 7E", "Photon 7X", "Photon 8P"]; //added brackets to the phones

// Units sold in the previous quarter
let sales = [10281, 12255, 25718, 21403, 16142]; //added brackets to sales
...
sales.forEach(addToTotal); //change t to T in addToTotal

// For loop to generate bar chart of phone sales // make i = 0 instead of 1 and make < instead of <=
for (let i = 0; i <=phones.length; i++) {
   
   let barChart = "";   // Variable to store HTML code for table cells used to create bar chart
   
   // Calculate the percent of total sales for a particular phone model // add
   let barPercent = 100*(sales[i]/totalSales); // add parenthesis around sales/totalSales so the whole is multiplied
   ...
   } // add : after the case declarations before cellTage =
